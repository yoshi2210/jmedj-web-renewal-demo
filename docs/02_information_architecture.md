...
> 2026-07-25追記: 本文中の「4ゾーン」は初期案であり、媒体種別と求人・物件サービスを同列にした点が不十分だった。現在の実装基準は [14_ia_v7_implementation_plan.md](14_ia_v7_implementation_plan.md) とし、診療領域・テーマ・記事形式・コンテンツ種別を独立した分類軸として扱う。
