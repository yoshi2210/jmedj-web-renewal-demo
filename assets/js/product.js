(function () {
  ...
  jmedjLoadContent(function (data) {
    ...
    var related = all.filter(function (i) { return i.category === item.category && i.id !== item.id; }).slice(0, 4);
    ...
    if (related.length === 0) {
      ...
      related.forEach(function (r) {
        ...
        card.addEventListener("click", function () { location.href = "product.html?id=" + r.id; });
